   <section
       class="flex flex-col justify-center items-center gap-5 md:gap-0 min-h-[55rem] md:min-h-[35rem] text-center bg-[#176B87]/90 mt-[-100px] p-5 pt-20 md:pb-0  font-poppins">
