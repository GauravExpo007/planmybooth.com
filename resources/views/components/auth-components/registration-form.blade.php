 <!-- Create Account Form -->
 <div id="create-account-form" class="p-8 bg-[#CBE2E8] rounded shadow-lg w-80 md:w-1/2 mx-auto mt-10 border">
     <h1 class="text-2xl text-[#3D94AC] font-semibold mb-6 text-center">Create Account</h1>
