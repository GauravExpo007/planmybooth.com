 <!-- Login Form -->
 <div id="login-form" class="p-8 bg-[#CBE2E8] rounded-2xl w-80 md:w-1/3 mx-auto mt-10 ">
     <h1 class="text-2xl text-[#3D94AC] font-semibold mb-6 text-center">Exhibitor Login</h1>
     <form id="login" action={{ route('auth.login') }} method="POST">
         ...
         <div class="mb-4">
             ...
             <input type="email" id="email" name="email"
                 class="w-full px-4 py-2 border bg-white border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"
